...
if HAS_CENTER_FAST:
    try:
        from pytim.center_fast import center_fast
...
if HAS_CENTER_FULL:
    try:
        from pytim.center_fast_full import center_full_optimized
...
try:
    from pytim.interface import Interface, HAS_CENTER_FAST as IF_HAS_FAST
    from pytim.interface import center_wrapper
